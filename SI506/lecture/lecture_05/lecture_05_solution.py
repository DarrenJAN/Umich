...
cleese_palin = cast[-9:-7] # alternative cast[3:5]

print(f"\nCh 01 Cleese and Palin = {cleese_palin}")

jones_graham_palin = cast[0:5:2]
...
menu_v2 = menu.replace('sausage', 'toast').replace('Spam, Spam, Spam', 'Spam, Spam, ' + healthy_choice).lower().splitlines()

# Multiline expression indicated by trailing slash after each line
# Note use of f-string
...
bonus_menu_v2 = (''.join(['Cereal, Toast, and Blueberries\n', menu])
...
menu_v3 = menu_v2.copy() # shallow copy
