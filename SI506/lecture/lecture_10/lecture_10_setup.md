...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_10/
cp lecture_10_setup.md lecture_10.md lecture_10.py ../Documents/umich/courses/SI506/lectures/lecture_10/
cd ../Documents/umich/courses/SI506/lectures/lecture_10/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_10`.

3. Copy (`cp`) the downloaded files to the `lecture_10` directory.
...
4. Navigate (`cd`) to your `lecture_10` directory.

5. Confirm "that the contents of the `lecture_10` directory are as expected (i.e., it contains
...
1. Hover over `lecture_10.md`, right-click, and select "Open Preview".
2. Hover over `lecture_10.py`, right-click, and select "Open to the Side".
